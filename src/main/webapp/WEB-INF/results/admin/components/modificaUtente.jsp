    ...
    <div class="contenitore-form">
        ...
        <form action="modifica-servlet-admin" method="post">
            ...
            <select id="ruolo" name="ruolo" required>
                <option value="magazziniere" <c:if test="${'magazziniere' == utente.ruolo}">selected</c:if>>Magazziniere</option>
                <option value="admin" <c:if test="${'admin' == utente.ruolo}">selected</c:if>>Admin</option>
            </select>
            <br><br>
