...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/magazziniere/components/aggiungiArrivo.css">
</head>
<body>
...
<div class="sezione">
    <div class="contenitore-form">
        ...
        <form action="inserisci-servlet-magazziniere" method="post">
            <input type="hidden" name="pageName" id="pageName" value="arrivo">
            ...
            <button type="submit">Inserisci Arrivo</button>
        </form>
