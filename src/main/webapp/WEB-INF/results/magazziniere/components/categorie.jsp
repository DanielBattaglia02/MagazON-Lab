...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/magazziniere/components/categorie.css">
</head>
<body>
    ...
    <!-- form nascosto2 -->
    <form id="hiddenForm2" action="visualizza-servlet-magazziniere" method="post" style="display:none;">
            ...
            <table class="tabella">
                ...
                <c:forEach var="categoria" items="${listaCategorie}">
                    <tr>
                        ...
                        <form action="eliminare-servlet-magazziniere" method="post">
                            <td>
                                <input type="hidden" name="IDcategoria" value="${categoria.ID}">
                                <input type="hidden" name="pageName" value="carrello">
