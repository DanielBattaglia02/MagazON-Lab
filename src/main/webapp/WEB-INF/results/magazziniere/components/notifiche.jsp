...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/magazziniere/components/notifiche.css">
</head>
<body>
...
<!-- form nascosto2 -->
<form id="hiddenForm2" action="modifica-servlet-magazziniere" method="post" style="display:none;">
